...
<p><span class="emoji">🧐</span> My research interests lie primarily in derivational (evaluative) morphology, morphosemantics, and quantitative and computational approaches to natural language, with a current focus on affix rivalry and polyfunctionality, semantic transparency in derivation, and paradigmatic morphology.</p>
</div>
